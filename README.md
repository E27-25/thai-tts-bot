...
<img src="./assets/cat9_v2.gif" alt="Aesthetic Cat" width="250" style="border-radius: 15px; margin: 20px 0;" />
...
<table width="100%" style="border-collapse: collapse;">
  <tr>
    <td width="50%" align="center">
      <img src="./assets/cat3_v2.gif" alt="Feature Cat 1" width="100" style="border-radius: 10px;" />
    ...
    <td width="50%" align="center">
      <img src="./assets/cat4_v2.gif" alt="Feature Cat 2" width="100" style="border-radius: 10px;" />
  ...
  <tr>
    <td width="50%" align="center">
      <img src="./assets/cat5_v2.gif" alt="Feature Cat 3" width="100" style="border-radius: 10px;" />
    ...
    <td width="50%" align="center">
      <img src="./assets/cat6_v2.gif" alt="Feature Cat 4" width="100" style="border-radius: 10px;" />
...
<div align="center">
  <img src="./assets/cat7_v2.gif" alt="Window Cat" width="250" style="border-radius: 15px; margin-top: 20px; margin-bottom: 20px;" />
</div>
...
| 🐾 <kbd>!join</kbd> / <kbd>!leave</kbd> | | Manually control the bot's voice channel presence. |
  ...
  <br/>
  <img src="./assets/cat8_v2.gif" alt="Command Cat" width="200" style="border-radius: 15px; margin-top: 20px;" />
...
<br/>
<div align="center">
  <img src="./assets/cat9_v2.gif" alt="Architecture Cat" width="250" style="border-radius: 15px; margin-bottom: 20px;" />
  <br/>
  <img src="./assets/cat10_v2.gif" alt="Coffee Cat" width="150" style="border-radius: 15px;" />
